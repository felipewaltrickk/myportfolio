            ...
            <div className={styles.EndLeft}>
                <div className={styles.LeftContent}>
                    <h2>Let's work together. <br />
                        ...
                        projects and <br />
                        much more.</h2>
                    <p>Seeking kindred spirits who enjoy the beauty of art-infused technology. Let's unite our talents and inovate together.</p>
                    <div className={styles.Body}>
                        <a className={styles.Button} href='mailto:waltrick.contato@gmail.com' target='_blank' type='name'>
                            ...
                            <span className={styles.Spanzinho}>Mail</span>
                        </a>
                        <div className={styles.Button}>
                            <a className={styles.Icon} href='https://www.linkedin.com/in/felipe-waltrick/' target='blank' type='mail'>
                            ...
                            <span className={styles.Spanzinho}>Linkedin</span>
                        </div>
                        <div className={styles.Button}>
                            <a className={styles.Icon} href='https://dribbble.com/felipewaltrick_' target='blank'>
                            ...
                            <span className={styles.Spanzinho}>Dribbble</span>
                        </div>
                        <div className={styles.Button}>
                            <a className={styles.Icon} href='https://www.behance.net/felipewaltrick2' target='blank'>
                            ...
                            <span className={styles.Spanzinho}>Behance</span>
                        </div>
                        <div className={styles.Button}>
                            <a className={styles.Icon} href='https://github.com/felipewaltrickk' target='blank'>
                            ...
                            <span className={styles.Spanzinho}>Github</span>
                        </div>
                    </div>
                </div>
            </div>
